...
export default ({children}) => (
  <Layout title="Building an FAQ chatbot">{children}</Layout>
);

# How we got into YC even though they wanted us to pivot
...
_My Inbox sits at 513 unread. My phone sits besides me. I wait. Trying to distract myself with videos. It’s hard to focus. We had just finished our YC interview and were waiting to hear back. It’s no by email and yes by phone call. I just want to know. Inbox sits at 514. It’s spam… More waiting and distracting myself. 1.5 more hours. Time has never felt so slow_

_3 hours later. Inbox hits 514. It’s from YC but it’s not a rejection._
...
<Box mb={3} textAlign="center">
  <Box mb={2}>
    <Image
      alt="Email 1"
      src="../images/yc-application/Email1.png"
    />
  </Box>
</Box>
...
<Box mb={3} textAlign="center">
  <Box mb={2}>
    <Image
      alt="Email 1"
      src="../images/yc-application/Email2.png"
    />
  </Box>
</Box>
...
<Box mb={3} textAlign="center">
  <Box mb={2}>
    <Image
      alt="Email 3"
      src="../images/yc-application/Email3.png"
    />
  </Box>
</Box>
...
<Box mb={3} textAlign="center">
  <Box mb={2}>
    <Image
      alt="Email 4"
      src="../images/yc-application/Email4.png"
    />
  </Box>
</Box>
...
<Box mb={3} textAlign="center">
  <Box mb={2}>
    <Image
      alt="Email 5"
      src="../images/yc-application/Email5.png"
    />
  </Box>
</Box>
...
<Box mb={3} textAlign="center">
  <Box mb={2}>
    <Image
      alt="Email 6"
      src="../images/yc-application/Email6.png"
    />
  </Box>
</Box>
