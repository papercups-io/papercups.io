...
export default ({children}) => (
  <Layout title="Hacktober Fest">{children}</Layout>
);
...
The month of October happens to be “[Hacktober Fest](https://hacktoberfest.digitalocean.com/details)”, so we decided that for the next 31 days, our primary focus will be on the developer community around Papercups 🙂
